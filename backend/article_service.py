...
class ArticleService:
    ...
    def create_article(self, article_data: dict, db: Session) -> str:
        category = db.query(Category).filter(Category.id == article_data.get('category_id')).first()
    ...
    def get_articles(self, db: Session, page: int = 1, size: int = 20, category_id: str = None, search: str = None):
