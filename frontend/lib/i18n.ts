...
const translations: Record<Language, Record<string | number, string>> = {
	...
	en: {
		...
		标题模板: "Title template",
		支持占位符组合生成每期标题: "Supports placeholders for generating each issue title",
		查看标题模板占位符说明: "View supported title template placeholders",
		支持占位符: "Supported placeholders",
		"当前回顾周期，如 2026-04 或 2026-03-30 ~ 2026-04-05":
			"Current review period, for example 2026-04 or 2026-03-30 ~ 2026-04-05",
		当前模板名称: "Current template name",
		"按当前模板已发布期数 + 1 计算": "Computed as published issue count for this template plus 1",
		"支持全部文章占位符 {{review_article_sections}} 和单篇文章占位符 {{article_slug}}。":
			"Supports the full article placeholder {{review_article_sections}} and per-article placeholder {{article_slug}}.",
		示例: "Example",
		...
		关键词: "Keyword",
		"输入文章或回顾标题搜索...": "Search by article or review title...",
		评论人: "Commenter",
		已隐藏: "Hidden",
		类型: "Type",
		日期范围: "Date range",
		...
		模板筛选: "Template Filter",
		展开: "Expand",
		收起: "Collapse",
		收起版本: "Hide versions",
		全部文章: "All articles",
		回顾模板: "Review template",
		高级筛选: "Filters",
		创建时间: "Created time",
		全部: "All",
		"1天内": "Last 1 day",
	...
	回顾: "Reviews",
		...
		// 回顾相关
		全部回顾: "All reviews",
		周期回顾: "Periodic reviews",
		配置周期性回顾模板并自动生成草稿:
			"Configure periodic review templates and auto-generate drafts",
		按周: "Weekly",
		按月: "Monthly",
		自定义天数: "Custom days",
		手动: "Manual",
		...
		下次触发: "Next trigger",
		新建模板: "New template",
		编辑回顾模板: "Edit review template",
		复制回顾模板: "Duplicate review template",
		创建回顾模板: "Create review template",
		模板名称: "Template name",
		全部分类: "All categories",
		包含全部分类: "Include all categories",
		立即生成: "Generate now",
		回顾模板预览: "Review template preview",
		个已选分类: "selected categories",
		自动计算中: "Auto calculating",
		篇文章已选择: "articles selected",
		回顾生成预览加载失败: "Failed to load review generation preview",
		回顾生成配置加载失败: "Failed to load review generation config",
		请先选择模板: "Please select a template first",
		请先选择完整时间区间: "Please select a complete time range",
		请至少选择一篇文章: "Please select at least one article",
		...
		默认模型: "Default model",
		留空使用默认值: "Leave empty to use default value",
		分类选择: "Category selection",
		当前回顾未关联模板无法重新生成:
			"Current review is not associated with a template, cannot regenerate",
		回顾已保存: "Review saved",
		回顾保存失败: "Failed to save review",
		回顾已撤回: "Review unpublished",
		回顾已发布: "Review published",
		回顾发布状态更新失败: "Failed to update review publish status",
		回顾已删除: "Review deleted",
		回顾删除失败: "Failed to delete review",
		编辑回顾: "Edit review",
		重新生成回顾: "Regenerate review",
		发布回顾: "Publish review",
		...
		期: "Issue",
		候选文章: "Candidate articles",
		模版信息: "Template info",
		相关内容: "Related content",
		当前条件下暂无文章: "No articles under current conditions",
		复盘内容重点沉淀周期总结: "Review key points and settle periodic summaries",
	},
};
