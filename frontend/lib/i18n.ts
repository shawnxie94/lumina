...
const translations: Record<Language, Record<string | number, string>> = {
	...
	en: {
		...
		标签: "Tags",
		选择标签: "Select tags",
		输入或选择标签: "Type or select tags",
		个已选标签: " selected tags",
		自动打标状态: "Auto-tag status",
		已手动锁定: "Manually locked",
		未开始: "Not started",
		重新自动打标: "Regenerate tags",
		已提交自动打标任务: "Auto-tagging task submitted",
		自动打标提交失败: "Failed to submit auto-tagging task",
		文章解读: "AI insights",
